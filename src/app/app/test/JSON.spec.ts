...
import { JSONType, JsonReader } from "./../utilities/JSONUtils";

describe("JSON WRAPPER", () => {
  const fixture = __dirname + "/../annotated/test/config";
  let reader: any;
  let wrapper: any;
  beforeEach(function() {
    reader = new JsonReader(fixture, true);
  ...
  it("deberia encontrar una version del indice", () => {
    ...
    expect(wrapper.seek("not__exits_foo", "", wrapper.haystack)).to.be
      .undefined;
